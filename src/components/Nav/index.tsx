...
function Nav() {
  return (
    <nav className={Styles.nav}>
      <a className={Styles.logolink} href="/" aria-label="Link to the home page">
        <div className={Styles.monogram}>BA</div>
      </a>
      <a className={Styles.link} href="/projects" aria-label="Link to Portfolio">
        Portfolio
      </a>
      ...
      <a className={Styles.social} href="https://github.com/croustys" aria-label="Link to Github profile">
        <svg
          className={Styles.socialicon}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 16 16"
      ...
      <a className={Styles.social} href="https://dev.to/croustys" aria-label="Link to Dev.to Profile">
        <svg
          className={Styles.socialicon}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 40"
